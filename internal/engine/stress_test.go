...
func TestStressTexts(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:  "layout dot is russian yu inside word",
			input: wrongRU("я нажимаю на иконку и закрываю приложение."),
			want:  "я нажимаю на иконку и закрываю приложение.",
		},
		{
			name:  "layout comma is russian be inside word",
			input: wrongRU("мы собираемся добавить больше слов чтобы окончания проходили."),
			want:  "мы собираемся добавить больше слов чтобы окончания проходили.",
		},
		{
			name:  "russian slang words",
			input: wrongRU("че ты такой кринж это реально жиза и норм вайб."),
			want:  "че ты такой кринж это реально жиза и норм вайб.",
		},
		{
